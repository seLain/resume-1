    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Service Backend}
          {Working on a pre-startup project, LuckyStrike. A community to create, advertise and participate commercial lucky draw events. I was responsible for backend part and RESTful-API construction.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Secure Data Storage}
          {Built an encrypted, secure storage system based on Python and VeraCrypt. It is used to preserve key documents and databases by distributed, SHA-256 encrypted virtual disks.}
